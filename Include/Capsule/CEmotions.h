 ...
 * be active) \return Emotions handle.
 */
CL_DLL clCEmotions clCEmotions_Create(clCSession session, double speed,
 ...
 * passed. \return Emotions handle.
 */
CL_DLL clCEmotions clCEmotions_CreateCalibrated(clCNFBCalibrator calibrator,
                                                double speed,
                                                double maxSpeed) NOEXCEPT;
/**
...
CL_DLL void
clCEmotionsDelegateFloat_Set(clCEmotionsDelegateFloat delegate,
...
typedef void (*clCEmotionsHandlerEmotionalStatesUpdate)(
    clCEmotions, const clCEmotionalStates *);
...
CL_DLL void clCEmotionsDelegate_Set(clCEmotionsDelegate delegate,
                                    clCEmotionsHandler handler) NOEXCEPT;
CL_DLL clCEmotionsDelegate
clCEmotions_GetOnInitializedEvent(clCEmotions emotions) NOEXCEPT;
CL_DLL clCEmotionsDelegate
clCEmotions_GetOnCalibratedEvent(clCEmotions emotions) NOEXCEPT;

CLC_STRUCT(clCEmotionsDelegateString);
typedef void (*clCEmotionsHandlerString)(clCEmotions, const char *);
CL_DLL void
clCEmotionsDelegateString_Set(clCEmotionsDelegateString delegate,
                              clCEmotionsHandlerString handler) NOEXCEPT;
CL_DLL clCEmotionsDelegateString
clCEmotions_GetOnErrorEvent(clCEmotions emotions) NOEXCEPT;
 ...
 */
CL_DLL void clCEmotions_Initialize(clCEmotions emotions,
